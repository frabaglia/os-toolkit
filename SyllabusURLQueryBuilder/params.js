...
export const institutionParams = {
  pages: 1,
  fields: [
    1, 2
  ],
...
export const titleResultId = 1
export const authorResultId = 1
export const fieldResultId = 1
